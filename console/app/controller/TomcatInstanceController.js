...
Ext.define('webapp.controller.TomcatInstanceController', {
    ...
    control: {
        ...
        "#mybutton": {
            click: 'openTomcatInstanceWindow'
        }
    },
    ...
    openTomcatInstanceWindow: function(button, e, eOpts) {
                this.showTomcatInstanceWindow('new', 0);
    },
    ...
    showTomcatInstanceWindow: function(type, id) {

        var tomcatWindow = Ext.create("widget.TomcatInstanceWindow");
                tomcatWindow.show();

                if (type === "edit"){
                    tomcatWindow.title = "Edit Tomcat instance";
                }
    }
